export default function ControlInfo() {
    const controlTypeOptions = ['NumberBox','TextBox', 'TimeBox','DateBox', 'DateTimeBox','SelectBox', 'CheckBox','PasswordBox','ArraySelectBox','ArrayInput','Button','ArrayButton','Radio'];
