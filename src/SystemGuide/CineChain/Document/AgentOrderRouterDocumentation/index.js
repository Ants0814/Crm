  ...
  const functions = [
    {
      path: '/assign',
      method: 'POST',
      description: '특정 주문을 대행자에게 할당하고, 대행 주문 시작 테이블에 데이터를 추가합니다.',
      details: [
        {
          title: '요청 형식',
        ...
        {
          title: '저장되는 데이터',
          content: 'crm_unchain.ants_unchain_agent_order 테이블에서 assigned_agent, agent_status, updated_at를 업데이트하고, menu_id를 기준으로 업데이트합니다. crm_unchain.ants_unchain_agent_order_start 테이블에 새로운 대행 주문 시작 정보를 추가합니다.'
        },
        {
          title: '응답',
        ...
        {
          title: '설명',
          content: '특정 주문을 대행자에게 할당하며, 주문이 시작되었음을 기록합니다.'
        }
      ]
    },
    {
      ...
      details: [
        ...
        {
          title: '저장되는 데이터',
          content: 'crm_unchain.ants_unchain_agent_order_start 테이블에서 예약 정보와 상태를 업데이트합니다.'
        },
        {
          title: '응답',
    ...
    },
    {
      ...
      details: [
        ...
        {
          title: '반환되는 데이터',
          content: 'crm_unchain.ants_unchain_agent_order 테이블에서 assigned_agent가 현재 대행자이거나 agent_status가 "assigned"인 주문을 조회합니다.'
        },
        {
          title: '응답',
    ...
    },
    {
      ...
      details: [
        ...
        {
          title: '반환되는 데이터',
          content: 'crm_unchain.ants_unchain_agent_order 테이블에서 agent_status가 "assigned"인 모든 주문을 조회합니다.'
        },
        {
          title: '응답',
    ...
    },
    {
      ...
      details: [
        ...
        {
          title: '저장되는 데이터',
          content: 'crm_unchain.ants_unchain_agent_order 테이블에서 agent_status를 "completed"로 업데이트하고, crm_pinecinema.ants_movie_orders 테이블에서 agent_status를 "completed"로 업데이트합니다.'
        },
        {
          title: '응답',
